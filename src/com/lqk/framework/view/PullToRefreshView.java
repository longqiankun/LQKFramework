...
import com.lqk.framework.util.ImageUtil;
...
public class PullToRefreshView extends LinearLayout {
	...
	private void addHeaderView() {
		...
		downBitmap = ImageUtil.getScacleBitmap(downBitmap,(int)(downBitmap.getWidth()*rote), (int)(downBitmap.getHeight()*rote));
		upBitmap = ImageUtil.getScacleBitmap(upBitmap,(int)(upBitmap.getWidth()*rote), (int)(upBitmap.getHeight()*rote));
